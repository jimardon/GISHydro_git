function recalculatetc(){
    ...
    function mergeswale(){
        ...
        tl_temp[subarea] = tot_length_sheet.concat(tot_lengthmerge).concat(Number(tot_length_channel) + parseFloat(tot_length_sheet[tot_length_sheet.length - 1]).toFixed(1))
    ...
    function mergechannel(){
        ...
        tl_temp[subarea] = tot_length_sheet.concat(tot_length_shallow).concat(Number(tot_lengthmerge) + parseFloat(tot_length_shallow[tot_length_shallow.length - 1]).toFixed(1))
