function recalculatetc(){
    ...
    var pixel_channel = Pixel_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var type_channel = Type_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var elev_channel = Elev_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var slope_channel = Slope_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var avgarea_channel = AvgArea_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var width_channel = Width_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var depth_channel = Depth_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var xarea_channel = Xarea_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var tot_length_channel = Tot_Length_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
    var vel_channel = Vel_[subarea].slice(occcounts['swale'],occcounts['swale']+occcounts['channel'])
